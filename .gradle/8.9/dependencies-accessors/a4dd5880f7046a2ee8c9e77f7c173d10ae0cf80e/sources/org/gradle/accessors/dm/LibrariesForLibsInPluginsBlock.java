...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ConverterLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>retrofit.converter.gson</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class LoggingVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>logging.interceptor</b> with value <b>4.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        private final RetrofitConverterVersionAccessors vaccForRetrofitConverterVersionAccessors = new RetrofitConverterVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.retrofit.converter</b>
         */
        public RetrofitConverterVersionAccessors getConverter() {
            return vaccForRetrofitConverterVersionAccessors;
        }

    }

    public static class RetrofitConverterVersionAccessors extends VersionFactory  {

        public RetrofitConverterVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>retrofit.converter.gson</b> with value <b>2.6.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGson() { return getVersion("retrofit.converter.gson"); }
