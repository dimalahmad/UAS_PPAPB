...
public final class DataPemilihDatabase_Impl extends DataPemilihDatabase {
  private volatile DataPemilihDao _dataPemilihDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void dropAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("DROP TABLE IF EXISTS `dataPemilih_table`");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashSet<TableInfo.Index> _indicesDataPemilihTable = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoDataPemilihTable = new TableInfo("dataPemilih_table", _columnsDataPemilihTable, _foreignKeysDataPemilihTable, _indicesDataPemilihTable);
        final TableInfo _existingDataPemilihTable = TableInfo.read(db, "dataPemilih_table");
        if (!_infoDataPemilihTable.equals(_existingDataPemilihTable)) {
          return new RoomOpenHelper.ValidationResult(false, "dataPemilih_table(com.dimalahmad.kpu.Database.DataPemilih).\n"
                  + " Expected:\n" + _infoDataPemilihTable + "\n"
                  + " Found:\n" + _existingDataPemilihTable);
        }
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "dataPemilih_table");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `dataPemilih_table`");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(DataPemilihDao.class, DataPemilihDao_Impl.getRequiredConverters());
  ...
  @Override
  public DataPemilihDao dataPemilihDao() {
    if (_dataPemilihDao != null) {
      return _dataPemilihDao;
    } else {
      synchronized(this) {
        if(_dataPemilihDao == null) {
          _dataPemilihDao = new DataPemilihDao_Impl(this);
        }
        return _dataPemilihDao;
      }
    }
