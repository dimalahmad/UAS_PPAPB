...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `user` (`id`,`username`,`password`,`status`) VALUES (nullif(?, 0),?,?,?)";
      }
  ...
  @Override
  public Object getUserByUsernameAndPassword(final String username, final String password,
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpId,_tmpUsername,_tmpPassword,_tmpStatus);
          } else {
            _result = null;
          }
          return _result;
